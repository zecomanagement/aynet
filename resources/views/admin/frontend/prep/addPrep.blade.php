        ...
        <!-- Content Header (Page header) -->
            <section class="content">
                ...
                <!-- Basic Forms -->
                    ...
                    <div class="row">
                    <div class="col">
                        <form method="POST" action="{{ route('store.prep')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <h5>No of Acres <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <h5>Proposed Date <span class="text-danger">*</span></h5>
                                            <div class="controls">
