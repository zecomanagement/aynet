    ...
    <div id="main-content" class="main-content">
        ...
        <div class="carousel-container">
            <div class="carousel-section">
                ...
                <h3><a href="{{route('shop.view')}}">Buy Seedlings</a></h3>
            ...
            <div class="carousel-section">
                ...
                <h3><a href="{{route('add.prep')}}">Get Extension</a></h3>
            ...
            <div class="carousel-section">
                ...
                <h3><a href="{{route('add.ext')}}">Prepare Land</a></h3>
            ...
            <div class="carousel-section">
                ...
                <h3><a href="{{route('add.sales')}}">Sell Trees</a></h3>
