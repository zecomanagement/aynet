                ...
                <ul class="biolife-carousel nav-none-on-mobile nav-insite-grid-1170 nav-larger" data-slick='{"arrows": true, "dots": false, "slidesMargin": 0, "slidesToShow": 1, "infinite": true, "speed": 800}' >
                    ...
                    <li>
                        <div class="slide-contain biolife-slide__ten">
                            ...
                            <div class="text-content">
                                <b class="second-line">Buy Seedlings</b>
                                
                                <p class="third-line">Get quality seedlings from our shops</p>
                                <p class="buttons">
                                    <a href="{{ route('shop.view') }}" class="btn">Start Buying</a>
                                </p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="slide-contain biolife-slide__ten biolife-slide__ten--elm-07">
                            <div class="media"></div>
                            <div class="text-content">
                                <b class="second-line">Get Extension</b>
                                <p class="third-line">Book for an extension</p>
                                
                                <p class="buttons">
                                    <a href="{{ route('add.prep') }}" class="btn">Start Booking</a>
                                </p>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="slide-contain biolife-slide__ten biolife-slide__ten--elm-08">
                            <div class="media"></div>
                            <div class="text-content">
                                <b class="second-line">Prepare Land</b>
                                <p class="third-line">Prepare your land</p>
                                
                                <p class="buttons">
                                    <a href="{{ route('add.ext') }}" class="btn">Start Booking</a>
                                </p>
                            </div>
                        </div>
                    </li>
