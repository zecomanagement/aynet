        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="primary-menu">
                        <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu" style="padding:25px;">
                            <li class="menu-item menu-item-has-children has-child">
                                <a href="{{route('home.view')}}" class="menu-name" data-title="Products">Home</a>
                                <ul class="sub-menu">
                                    <li class="menu-item"><a href="{{route('outgrower.view')}}">Outgrowers App</a></li>
                                    <li class="menu-item"><a href="{{route('virtual.view')}}">Virtual Farmer App</a></li>
                                    <li class="menu-item"><a href="{{route('consumer.view')}}">End Consumer App</a></li>
                                       
                                </ul>
                            </li>
                            
                            <li class="menu-item">
                                <a href="{{route('shop.project.view')}}" class="menu-name" data-title="Products">Buy Trees</a>
                                
                            </li>
                            <!--<li class="menu-item">
                                <a href="" class="menu-name" data-title="Products">Sell Trees</a>
                                
                            </li>-->
                            <li class="menu-item">
                                <a href="{{route('view.trees')}}" class="menu-name" data-title="Products">Donate Trees</a>
                                
                            </li>
                            <li class="menu-item">
                                <a href="{{route('add.visit')}}" class="menu-name" data-title="Products">Visit Site</a>
                ...
                <div class="header-ten__left-menu col-lg-4 col-md-4 col-md-6 hidden-sm hidden-xs">
                    ...
                    @else
                    <ul class="left-menu" style="padding:25px;">
                        <li><a href="{{route('vf.add')}}" class="login-link link-to">
                            <figure><img src={{asset('frontend/assets/images/home-10/person-icon.png')}} width="22" height="19" alt=""></figure>
                        ...
                        <div class="minicart-block">
                            ...
                            <div class="cart-content">
                                <div class="cart-inner">
                                        ...
                                        <li>
                                            @foreach ($cart as $seed)
                                                <div class="minicart-item">
                                                    <div class="thumb">
                                                        <a href="#"><img src={{ asset('upload/plots/'.trim($seed->options->get('image'), '"'))}} width="90" height="90" style="width:60px; height:60px;" alt="National Fresh"></a>
                                                    </div>
                                                    <div class="left-info">
                                    ...
                                    <p class="btn-control">
                                        <a href="{{route('cart.view.projects')}}" class="btn view-cart">view cart</a>
