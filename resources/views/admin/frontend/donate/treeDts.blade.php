            ...
            <div class="sumary-product single-layout product-data">
                <div class="media">
                    <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                        <li><img src={{ asset('upload/tree_image/'.trim($trees->image, '"'))}} alt="" width="500" height="500"></li>
                ...
                <div class="product-attribute">
                    <h3 class="title">{{ $trees->name }}</h3>
                    <div class="rating">
                        <b class="category">By: Aynet Limited</b>
                    </div>
                    <span class="sku"></span>
                    <p class="excerpt">{{ $trees->briefDesc }}</p>
                    <div class="price">
                        <ins><span class="price-amount"><span class="currencySymbol">Ksh</span>{{ $trees->price }}</span></ins>
                ...
                <form  action="{{route('donate.trees.store')}}" method="POST">
                    @csrf
                    <div class="action-form">
                        <div class="quantity-box">
                            <input type="hidden" value="{{ $trees->id }}" class="seed_id" name="tree_id">
