                        ...
                        <li class="product-item">
                            <div class="contain-product layout-default layout-default--light">
                                <div class="product-thumb">
                                    <a href="{{url('trees/details/'.$tree->id)}}" class="link-to-product">
                    
                                        <img src="{{ asset('upload/tree_image/'.trim($tree->image, '"'))}}"  alt="Vegetables" width="216" height="276" class="product-thumnail">
                                    </a>
                                    <div class="buttons">
                                ...
                                <div class="info">
                                    <h4 class="product-title"><a href="{{url('trees/details/'.$tree->id)}}" class="pr-name">{{$tree->name}}</a></h4>
                                    <div class="price ">
                                        <ins><span class="price-amount">KES{{$tree->price}}</span></ins>
