    ...
    <div class="sumary-product single-layout product-data">
        <div class="media">
            <ul class="biolife-carousel slider-for" data-slick='{"arrows":false,"dots":false,"slidesMargin":30,"slidesToShow":1,"slidesToScroll":1,"fade":true,"asNavFor":".slider-nav"}'>
                <li><img src={{ asset('upload/subSection_image/'.trim($subSect->image, '"'))}} alt="" width="500" height="500"></li>
        ...
        <div class="product-attribute">
            <h3 class="title">{{ $subSect->name }}</h3>
            <div class="rating">
                <b class="category">By: Aynet Limited</b>
            </div>
            <span class="sku"></span>
            <p class="excerpt">{{ $subSect->briefDesc }}</p>
            <div class="price">
        ...
        <form  action="{{route('cart.sub.store')}}" method="POST">
            @csrf
            <div class="action-form">
                <div class="quantity-box">
                    <input type="hidden" value="{{ $subSect->id }}" class="seed_id" name="subSect">
            ...
            <div class="product-tabs single-layout biolife-tab-contain">
                ...
                <div class="tab-content">
                    <div id="tab_1st" class="tab-contain desc-tab active">
                        <p class="desc"> {{ $subSect->longDesc}}.</p>
