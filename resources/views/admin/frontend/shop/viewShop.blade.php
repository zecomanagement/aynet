                        ...
                        <li class="product-item">
                            <div class="contain-product layout-default layout-default--light">
                                <div class="product-thumb">
                                    <a href="{{url('/product/details/' .$seed->id)}}" class="link-to-product">
                    
                                        <img src="{{ asset('upload/products/'.trim($seed->image, '"'))}}" alt="Vegetables" width="216" height="276" class="product-thumnail">
                                    </a>
                                    <div class="buttons">
                                ...
                                <div class="info">
                                    <h4 class="product-title"><a href="{{url('/product/details/' .$seed->id)}}" class="pr-name">{{$seed->name}}</a></h4>
                                    <div class="price ">
