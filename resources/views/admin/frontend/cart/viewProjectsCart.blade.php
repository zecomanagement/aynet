                                ...
                                <tr class="cart_item">
                                    <td class="product-thumbnail" data-title="Product Name">
                                        <a class="prd-thumb" href="#">
                                            <figure><img width="113" height="113" style="width:60px; height:60px;" src={{ asset('upload/plots/'.trim($row->options->get('image'), '"'))}} alt="shipping cart"></figure>
                                        </a>
            ...
            <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                <div class="shpcart-subtotal-block">
                    ...
                    <div class="btn-checkout">
                        <a href="{{route('cart.project.checkout')}}" class="btn checkout">Check out</a>
                    </div>
