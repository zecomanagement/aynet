        ...
        <div class="container">
            <div class="row">
                ...
                <div class="header-ten__menu-contain col-lg-6 col-md-6 hidden-sm hidden-xs md-possition-initial">
                    <div class="primary-menu">
                        <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu" style="padding:25px;">
                            ...
                            <li class="menu-item">
                                <a href="{{route('shop.view')}}" class="menu-name" data-title="Products">Seedlings</a>
                                
                            </li>
                            <li class="menu-item">
                                <a href="{{route('add.prep')}}" class="menu-name" data-title="Products">Prepare Land</a>
                                
                            </li>
                            <li class="menu-item">
                                <a href="{{route('add.ext')}}" class="menu-name" data-title="Products">Extension</a>
                                
                            </li>
                            <li class="menu-item">
                                <a href="{{route('add.sales')}}" class="menu-name" data-title="Products">Sell Trees</a>
                ...
                <div class="header-ten__left-menu col-lg-4 col-md-4 col-md-6 hidden-sm hidden-xs">
                    ...
                    @else
                    <ul class="left-menu" style="padding:25px;">
                        <li><a href="{{route('cl.add')}}" class="login-link link-to">
                            <figure><img src={{asset('frontend/assets/images/home-10/person-icon.png')}} width="22" height="19" alt=""></figure>
                            <p class="texts">Register</p>
                        </a></li>
                                            ...
                                            @foreach ($cart as $seed)
                                                <div class="minicart-item">
                                                    <div class="thumb">
                                                        ...
                                                        <a href="#"><img src={{ asset('upload/products/'.trim($seed->options->get('image'), '"'))}} width="90" height="90" style="width:60px; height:60px;" alt="National Fresh"></a>
                                                    </div>
                                                    <div class="left-info">
