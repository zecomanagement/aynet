        ...
        <div class="container">
            <div class="row">
                ...
                <div class="header-ten__menu-contain col-lg-6 col-md-6 hidden-sm hidden-xs md-possition-initial">
                    <div class="primary-menu">
                        <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu" style="padding:25px;">
                            ...
                            <li class="menu-item menu-item-has-children has-child">
                                <a href="#" class="menu-name" data-title="Products">Lumber</a>
                                <ul class="sub-menu">
                                    <li class="menu-item"><a href="{{route('view.ep')}}">Dimension Lumber</a></li>
                            ...
                            <li class="menu-item menu-item-has-children has-child">
                                <a href="#" class="menu-name" data-title="Products">Furniture</a>
                                <ul class="sub-menu">
                            ...
                            <li class="menu-item menu-item-has-children has-child">
                                <a href="#" class="menu-name" data-title="Products">Biofuel</a>
                                <ul class="sub-menu">
                                    ...
                                    <li class="menu-item"><a href="{{route('view.ep')}}">Ethanol</a></li>
                                </ul>
                            </li>
                ...
                <div class="header-ten__left-menu col-lg-4 col-md-4 col-md-6 hidden-sm hidden-xs">
                    ...
                    @else
                    <ul class="left-menu" style="padding:25px;">
                        <li><a href="{{route('online.con.add')}}" class="login-link link-to">
                            <figure><img src={{asset('frontend/assets/images/home-10/person-icon.png')}} width="22" height="19" alt=""></figure>
                                        ...
                                        <li>
                                            @foreach ($cart as $seed)
                                                <div class="minicart-item">
                                                    <div class="thumb">
                                                        <a href="#"><img src={{ asset('upload/tree_image/'.trim($seed->options->get('image'), '"'))}} width="90" height="90" alt="National Fresh"></a>
                                                    </div>
                                                    <div class="left-info">
