    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                ...
                @elseif($products->category == 'end_products')
                    <li class="nav-item"><a href="index-2.html" class="permal-link">Home</a></li>
                    <li class="nav-item"><a href="#" class="permal-link">End Products</a></li>
                    <li class="nav-item"><span class="current-page">Best Quality Tree Products</span></li>
                @else
                    <li class="nav-item"><a href="index-2.html" class="permal-link">Home</a></li>
                ...
                <div class="sumary-product single-layout product-data">
                    <div class="media">
                        <ul class="biolife-carousel slider-for"
                            ...
                            <li><img src={{ asset('upload/products/' . trim($products->image, '"')) }} alt=""
                    ...
                    <div class="product-attribute">
                        ...
                        <div class="price">
                            <ins><span class="price-amount"><span
                                        class="currencySymbol">Ksh</span>{{ $products->unit_price }}</span></ins>
                        ...
                        <div class="action-form">
                            ...
                            <div class="acepted-payment-methods">
                                <ul class="payment-methods">
                                    <li><img src={{ asset('frontend/assets/images/card1.jpg') }} alt=""
                                            width="51" height="36"></li>
                                    <li><img src={{ asset('frontend/assets/images/card2.jpg') }} alt=""
                                            width="51" height="36"></li>
                                    <li><img src={{ asset('frontend/assets/images/card3.jpg') }} alt=""
                                            width="51" height="36"></li>
                                    <li><img src={{ asset('frontend/assets/images/card4.jpg') }} alt=""
                                            width="51" height="36"></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div id="tab_2nd" class="tab-contain addtional-info-tab">
                            <section class="google-map-section">
                                <div class="map-inner">
                                    ...
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.8300336549873!2d36.81956191475392!3d-1.2752974990698362!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f17297069cf95%3A0x51af5e1d8fff1472!2sVillage%20Plaza!5e0!3m2!1sen!2ske!4v1677578059477!5m2!1sen!2ske"
