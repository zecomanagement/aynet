                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="category" class="form-control">
                                                        ...
                                                        <option value="end_products">End Products</option>
                                                    </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="unit_price"  class="form-control" value="{{$editProduct->unit_price}}"> 
                                                    @error('name')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="amount" class="form-control" value="{{$editProduct->amount}}"> 
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="brief_desc" id="textarea" class="form-control"  placeholder="Narration...">{{$editProduct->brief_desc}}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="long_desc" id="textarea" class="form-control"  placeholder="Narration...">{{$editProduct->long_desc}}</textarea>
                                                <div class="help-block"></div></div>
                                            </div>
                                        </div> 
                                    </div>
