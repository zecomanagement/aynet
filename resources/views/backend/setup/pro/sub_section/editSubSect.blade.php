            ...
            <!-- Basic Forms -->
             <div class="box">
               <div class="box-header with-border">
                 <h4 class="box-title">Edit Sub-Sections</h4>
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                       <form method="POST" action="{{ route('sub.sect.update', $editData->id)}}" enctype="multipart/form-data">
                        @csrf
                         <div class="row">
                           <div class="col-12">	
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="pro_id"  id="pro_id" class="form-control">
                                                        ...
                                                        @foreach ($pro as $pr)
                                                            <option value="{{ $pr->id }}"{{ ($editData->pro_id ==
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="sect_id" id="sect_id" required="" class="form-control">
                                                        ...
                                                        @foreach ($sect as $st)
                                                            <option value="{{ $st->id }}"{{ ($editData->sect_id ==
                                                                $st->id)? "selected":"" }}>{{ $st->name }}</option> 
                                                        @endforeach  
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="sp_id"   class="form-control">
                                                        ...
                                                        @foreach ($seed as $sd)
                                                            <option value="{{ $sd->id }}"{{ ($editData->sp_id ==
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="trees" id="trees" class="form-control" value="{{$editData->trees}}"> 
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="uPrice" id="uPrice" class="form-control"  value="{{$editData->uPrice}}"> 
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="value" id="total" class="form-control" value="{{$editData->value}}" readonly> 
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="date" name="pl_date"  class="form-control"  value="{{$editData->pl_date}}"> 
                                                    @error('name')
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="date" name="mat_date"  class="form-control" value="{{$editData->mat_date}}"> 
                                                    @error('name')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="briefDesc" id="textarea" class="form-control"  placeholder="Narration...">{{$editData->briefDesc}}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="longDesc" id="textarea" class="form-control"  placeholder="Narration...">{{$editData->longDesc}}</textarea>
                                                <div class="help-block"></div></div>
                                            </div>
                                        </div> 
                                    </div>
