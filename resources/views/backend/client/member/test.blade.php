...
<head>
  <meta charset="utf-8">
    ...
    <title>Kejani - Registration </title>
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
							<form method="POST" action="{{ route('mb.store') }}">
                                @csrf
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" id="mobile" name="mobile" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Mobile">
									</div>
								</div>
