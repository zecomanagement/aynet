...
<head>
    ...
    <title>Aynet Registration Page</title>
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url('{{asset('backendd/assets/images/background/forest.jpg')}}'); no-repeat center center; background-size: cover;">
            <div class="auth-box p-4 bg-white">
                <div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal mt-3 form-material" method="POST" action="{{route('vf.store')}}">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-12">
                                        <input type="hidden" name="usertype" value="online">
                            ...
                            <div class="text-center">
								<p class="font-weight-medium mb-3">Already have an account? <a href="{{ route('login') }}" class="text-info ml-5">Login</a></p>
							</div>
                        </div>
                    </div>
                </div>
