            ...
            <!-- Basic Forms -->
             <div class="box">
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                       <form method="POST" action="{{ route('srv.ord.update', $editData->id)}}" enctype="multipart/form-data">
                        @csrf
                         <div class="row">
                           <div class="col-12">	
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="controls">
                                                    <select name="mb_id"  required="" class="form-control">
                                                        ...
                                                        @foreach ($member as $mb)
                                                            <option value="{{ $mb->id }}"{{ ($editData->mb_id ==
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="sv_id"  id="seedType" class="form-control">
                                                        ...
                                                        @foreach ($serv as $sv)
                                                            <option value="{{ $sv->id }}"{{ ($editData->sv_id ==
                                                                $sv->id)? "selected":"" }}>{{ $sv->name }}</option> 
                                                        @endforeach  
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="ppa" id="unitPrice" value="{{ $editData->ppa }}"  class="form-control" > 
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="qty" id="qty" value="{{ $editData->qty }}" class="form-control" > 
                                                    @error('name')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="amount" id="total" value="{{ $editData->amount }}" class="form-control" readonly> 
                                                    @error('name')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
